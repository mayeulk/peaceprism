...
require 'liste_controller'

# Re-raise errors caught by the controller.
class ListeController; def rescue_action(e) raise e end; end

class ListeControllerTest < Test::Unit::TestCase
  fixtures :conflitsexts

  def setup
    @controller = ListeController.new
