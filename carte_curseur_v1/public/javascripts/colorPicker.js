    ...
    if (!Control.ColorPicker.CONTROL) {
      ...
      if (!$("colorpicker")) {
        ...
        control.innerHTML = 
          ...
          '<div id="colorpicker-hue-container"><img src="' + this.options.IMAGE_BASE + 'hue.png" id="colorpicker-hue-bg-img"/><div id="colorpicker-hue-slider" style="width:10px; height:100px;"><div id="colorpicker-hue-thumb"><img src="' + this.options.IMAGE_BASE + 'hline.png"/></div></div></div>' + 

// <img src="' + this.options.IMAGE_BASE + 'hline.png"/>
	  ...
	  hueSlider = new Control.Slider('colorpicker-hue-thumb', 'colorpicker-hue-slider', {
          axis: 'vertical',
		  onSlide:function(v) {Control.ColorPicker.activeColorPicker.updateHue(v)},
          onChange: function(v) {Control.ColorPicker.activeColorPicker.updateHue(v);}
	  })
      Control.ColorPicker.CONTROL = {
        popUp : $("colorpicker"),
